...
public class TC_NewApplication_Login extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_NewApplication_Login(String testInstance, ExecutionMode executionMode, Platform platform
