...
public class TC_NewApplication_SmokeTest extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_NewApplication_SmokeTest(String testInstance, ExecutionMode executionMode, Platform platform
