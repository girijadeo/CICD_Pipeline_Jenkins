package testscripts.NewApplication;
...
public class TC_NewApplication_HomePageValidation extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_NewApplication_HomePageValidation(String testInstance, ExecutionMode executionMode, Platform platform
